...
export const FlashSale = () => {
    return (
        <section className="bg-[linear-gradient(to_top,#ffffff_0%,#fff3b9_100%)] p-[16px] relative rounded-[8px] [box-shadow:0px_1px_1px_0px_#00000024]" aria-labelledby="flashsale-heading">
            <div className="w-full">
                <header className="flex justify-between mb-[16px] items-end">
                    ...
                    <div>
                        <button className="text-[14px] bg-inherit border-none text-[#333333] font-[600]">Xem thêm</button>
                    </div>
                </header>

                <div className="flex gap-[14px]" role="list">
                    {demoProducts.map((p) => (
                        <div className="bg-[#fff] w-[168px] rounded-[8px] [box-shadow:0_1px_0_rgba(0,0,0,0.06)] flex flex-col flex-none overflow-hidden" key={p.id}>
                            ...
                            <div className="p-[8px] flex flex-col gap-[4px]">
                                ...
                                <div className="w-full">
                                    <div className="w-full h-[20px] relative bg-[#00833E]/25 rounded-full">
                                        ...
                                        <div className="absolute top-[50%] -translate-y-1/2 left-[50%] -translate-x-1/2 text-[10px] font-[500] text-[#FFFFFF]">Đang bán chạy</div>
                                    </div>
                                </div>
                            </div>
                        </div>
