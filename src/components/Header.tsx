        ...
        <div className="w-[908px] flex items-start gap-[20px]">
          <div className="w-[600px]">
            <div className="relative">
              ...
              />
              <img className="absolute top-[12px] right-[16px]" src="/src/assets/search.svg" alt="" />
            </div>
