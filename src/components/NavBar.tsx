...
export const NavBar = () => {
  return (
    <div className="bg-[#FFFFFF] w-[244px] flex flex-col gap-[20px] py-[16px] px-[12px] rounded-[8px] shadow-[0px_1px_1px_0px_#00000024] w-[244px] shrink-[0] self-baseline sticky top-[4px]">
