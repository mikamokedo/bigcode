      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
        <div className="flex gap-[16px] pt-[65px] pb-[16px]">
          <div className="w-[400px] max-w-full flex flex-col gap-[12px]">
            <img src="/assets/smartMarket.svg" alt="Chợ Thông Minh" className="w-[230px] h-[70px] object-cover" />
          ...
          <div className="max-w-7xl mx-auto px-6 flex flex-col gap-[16px]">
            <div className="flex items-center gap-[10px] py-[10px]  border-[#808080] border-t">
              ...
              <div className="flex items-center gap-6">
                <img src="/assets/light-BigCode.png" alt="Bigcode" className="h-6 object-cover w-[150px]" />
                <img src="/assets/gober.png" alt="Gober" className="h-[53px] object-cover w-[136px]" />
              </div>
            </div>
