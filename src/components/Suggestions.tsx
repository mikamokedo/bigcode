    ...
    return (
        <div className="flex flex-col gap-[16px]">
                        ...
                        <div className="" key={p.id}>
                            <div className="bg-[#fff] px-2 [box-shadow:0px_1px_1px_0px_#0000001A] w-[172px] rounded-[8px] flex flex-col flex-none overflow-hidden">
                                <div className="h-[172px] relative bg-[#e5e7eb]">
                                    <div className="absolute right-[8px] top-[8px] bg-[#d33] text-[white] py-[4px] text-[white] px-[8px] rounded-[6px] text-[12px] font-[600]" aria-hidden>{p.discount}</div>
                                ...
                                <div className="p-[8px] flex flex-col gap-[4px]">
                                    ...
                                    <div className="flex gap-[4px]">
                                        <div className="whitespace-nowrap rounded-r-[4px] w-fit text-[10px] font-[500] border-1 border-[#FF6F3C] text-[#FF6F3C] px-[4px] py-[6px] rounded-[4px]">Tặng 1 chai Chinsu</div>
                                    </div>
            ...
            <div className="flex justify-center">
                <button className="px-[50px] py-[10px] border-none bg-inherit text-[14px] font-[600] text-[#1E88E5] flex items-center cursor-pointer">Xem thêm 10 sản phẩm <img src="/src/assets/chevronDown.svg" alt="" /> </button>
            </div>
        </div>
    )
}