    ...
    <div className="z-10 relative bg-[linear-gradient(0deg,#138636,#138636),linear-gradient(0deg,rgba(0,0,0,0.2),rgba(0,0,0,0.2))] p-[12px] flex flex-col gap-[12px]">
      <div className="z-10 flex justify-between items-center">
        <div className="flex items-center gap-[12px]">
          <img src="/assets/arrowLeftMB.svg" alt="" className="cursor-pointer" />
        ...
        <div className="flex gap-[12px]">
          <button className="bg-inherit border-none cursor-pointer">
            <img src="/assets/basketHeaderMB.svg" alt="" />
          </button>
          <button className="bg-inherit border-none cursor-pointer">
            <img src="/assets/notificationMB.svg" alt="" />
          </button>
        </div>
      </div>
      <div className="z-10 w-full relative">
        ...
        />
        <img src="/assets/searchMB.svg" className="absolute top-[50%] translate-y-[-50%] left-[10px]" alt="" />
      </div>
      <img
        src="/assets/headerMB.jpg"
        className="transform scale-x-[-1] opacity-25 absolute top-[0px] left-[0px] w-full h-full inset-0 object-cover z-0"
        alt=""
      />
    </div>
  );
