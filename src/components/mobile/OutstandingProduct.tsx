const list = Array.from({ length: 8 }).map((_, i) => ({
    id: i + 1,
    img: '/src/assets/slide-bar1MB.png',
                        ...
                        return (
                            <div className="rounded-[8px]  bg-[#fff]">
                                ...
                                <div className="flex flex-col gap-[4px] py-[4px] px-[8px]">
                                    ...
                                    <div className="text-[12px] text-[#808080] line-through flex items-center gap-[4px]">1.470.000 <img src="/src/assets/discountMB.svg" alt="" /></div>
                                </div>
                            </div>
                        )
                    })}
